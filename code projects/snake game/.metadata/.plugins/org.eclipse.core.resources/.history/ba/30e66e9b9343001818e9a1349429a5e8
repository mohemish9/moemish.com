...
/**
 * SnakeMode - is an enumeration (aka enum) rather than an class. Enumerations
 ...
 * have had SpampedeData store a String (e.g. "N", "S", "E", "W", or "A")
 ...
 * use this enum (i.e., SnakeMode) we can't incorrectly set the mode within
 * SpampedeMode.
 * 
