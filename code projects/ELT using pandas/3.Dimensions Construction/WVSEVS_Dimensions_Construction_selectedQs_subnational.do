...
replace S002 = .  if S002 == .n
replace S002 = .  if S002 < 0
replace S002EVS = .  if S002EVS == .n
replace S002EVS = .  if S002EVS < 0
replace X048 = .  if X048 == .n
replace X048 = .  if X048 < 0
replace X048WVS = .  if X048WVS == .n
replace X048WVS = .  if X048WVS < 0
...
** Aggregate Loadings at the national level: sunational
 collapse (mean) F063 Y003 F120 G006 E018 Y002 A008 E025 F118 A165 A173 SAMPLE_SIZE, by (S001 S002_ALL S003 S009 S009A S020 S025 S026 X048_ALL)
* National-Level:
*collapse (mean) F063 Y003 F120 G006 E018 Y002 A008 E025 F118 A165 A173 , by (S001 S002 S003 S009 S020 S025 S026)


*Subnational Level: (General)
...
save regional_dimensions_all.0.0.2_selectedQs.dta,replace
