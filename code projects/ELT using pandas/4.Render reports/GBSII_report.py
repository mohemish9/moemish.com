...
vars.to_csv(interimPath + "GBSII_columns.csv")
...
waves.to_csv( interimPath + "GBSII_waves.csv")
...
countries.to_csv(interimPath + "GBSII_countries.csv")
...
no_dimensions.to_csv(interimPath + "GBSII_nodimensions.csv")
