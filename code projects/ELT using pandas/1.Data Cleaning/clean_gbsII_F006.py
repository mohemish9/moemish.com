...
arab10_12 = pd.read_csv(interimPath+"arab10_12_F006.csv")
arab10_12['UN_code'] = arab10_12.apply(lambda row: getUNCode(row['country']),axis=1)
arab10_12.to_csv(interimPath+"arab10_12_F006_c.csv")
del arab10_12
print('arab12 is done')

afro11_13 = pd.read_csv(interimPath+"afro11_13_F006.csv")
...
afro11_13.to_csv(interimPath+"afro11_13_F006_c.csv")
del afro11_13
print('afro11_13 is done')

latin13 = pd.read_csv(interimPath+"latin13_F006.csv")
latin13['UN_code'] = latin13.apply(lambda row: getUNCode(row['idenpa']),axis=1)
latin13.to_csv(interimPath+"latin13_F006_c.csv")
